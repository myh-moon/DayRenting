...
//            [alertView show];
            ...
            UIAlertController *noAlertController = [UIAlertController alertControllerWithTitle:@"相机" message:@"相机不可用" preferredStyle:UIAlertControllerStyleAlert];
            ...
            [weakself presentViewController:noAlertController animated:YES completion:nil];
